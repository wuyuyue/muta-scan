This project was for blockchain(by [Muta](https://github.com/nervosnetwork/muta)) explore User Interface, which was bootstrapped with [Create React App](https://github.com/facebook/create-react-app).
